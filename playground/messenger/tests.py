...
class ThreadTextCase(TestCase):
    ...
    def test_add_messages_to_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message1 = Message.objects.create(user=self.user1, content="blablabal")
        message2 = Message.objects.create(user=self.user2, content="dasdasdsad")
    ...
    def test_user_not_in_thread(self):
        ...
        message1 = Message.objects.create(user=self.user1, content="blablabal")
        message2 = Message.objects.create(user=self.user2, content="dasdasdsad")
        message3 = Message.objects.create(user=self.user3, content="dasdasdsad")
